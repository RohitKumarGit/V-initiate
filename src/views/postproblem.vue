<template>
    <div class="container postproject" >
        ...
        <b-field label="Explain the problem in detail">
            <b-input  type="textarea" v-model="desc"></b-input>
        </b-field>
         <b-field label="What need to be done to solve the problem?">
            <b-input  type="textarea" v-model="solution"></b-input>
        </b-field>
    ...
    methods:{
        ...
        async publish(){
           ...
           // var url;
            ...
            console.log(data)
            const {data} = await axios.post('/api/problem',datas);
            this.$router.push('/view_problem/'+data.problem._id)
                        });
                    });
